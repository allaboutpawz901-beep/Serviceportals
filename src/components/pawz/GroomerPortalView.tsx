        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between px-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-sm font-bold text-foreground leading-tight">All About<br/>Pawz</h1>
          ...
          <nav className="space-y-1">
            ...
            <div className="space-y-1">
              <button 
                type="button"
                className="w-full flex items-center justify-between px-3 py-2 text-xs font-semibold text-primary bg-primary/5/60 rounded-lg group"
              >
            ...
            <div className="pt-2 space-y-0.5 text-xs font-medium text-muted-foreground">
              <button 
                type="button"
              ...
              >
                ...
                <span className="bg-primary/5 text-primary text-[11px] font-bold px-1.5 py-0.5 rounded-full">2</span>
              </button>
              <button 
                type="button"
              ...
              >
                ...
                <span className="bg-destructive/10 text-destructive text-[11px] font-bold px-1.5 py-0.5 rounded-full">3</span>
              </button>
              <button 
                type="button"
        ...
        <div className="mt-8 pt-4 border-t border-border">
          <div className="bg-muted/40/70 border border-border rounded-xl p-3.5 space-y-3">
            ...
            <button
              ...
              className="w-full py-1.5 text-xs font-semibold text-primary bg-card border border-primary/20 rounded-lg shadow-2xs hover:bg-primary/5 transition-colors cursor-pointer"
            >
        ...
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Here&apos;s your day at a glance.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
                ...
                <div className="absolute right-0 mt-1.5 w-52 bg-card border border-border rounded-xl shadow-lg p-1 z-30 space-y-1">
                  {['May 12, 2025 (Today)', 'May 13, 2025 (Tomorrow)', 'May 14, 2025'].map((d) => (
                    <button
                      ...
                      className="w-full text-left px-3 py-1.5 text-xs text-foreground hover:bg-muted/40 rounded-lg flex items-center justify-between"
                    >
                      <span>{d}</span>
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-destructive/100 text-white text-[10px] font-bold rounded-full flex items-center justify-center">
                  3
                </span>
              </button>
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 bg-card border border-border rounded-2xl shadow-xl p-3 z-40 space-y-2">
                  <div className="flex items-center justify-between pb-2 border-b border-border">
                    <span className="text-xs font-bold text-foreground">Station Alerts</span>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left hidden sm:block">
                  <div className="text-xs font-bold text-foreground leading-tight">{currentUser.name}</div>
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-card border border-border rounded-2xl shadow-xl p-2 z-40 space-y-1">
                  <div className="px-3 py-2 border-b border-border">
                    ...
                    <span className="inline-block mt-1 px-2 py-0.5 rounded-full bg-primary/5 text-primary text-[10px] font-bold">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-primary hover:bg-primary/5 rounded-xl transition-colors cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-destructive hover:bg-destructive/10 rounded-xl transition-colors cursor-pointer"
                  >
          ...
          <div className="bg-card border border-border rounded-2xl p-4 shadow-2xs flex flex-col justify-between hover:shadow-xs transition-shadow">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-foreground leading-tight mt-0.5">7</div>
              </div>
            </div>
            <button 
          ...
          <div className="bg-card border border-border rounded-2xl p-4 shadow-2xs flex flex-col justify-between hover:shadow-xs transition-shadow">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-foreground leading-tight mt-0.5">$96.00</div>
              </div>
            </div>
            <button 
          ...
          <div className="bg-card border border-border rounded-2xl p-4 shadow-2xs flex flex-col justify-between hover:shadow-xs transition-shadow">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-foreground leading-tight mt-0.5">7h 30m</div>
              </div>
            </div>
            <button 
          ...
          <div className="bg-card border border-border rounded-2xl p-4 shadow-2xs flex flex-col justify-between hover:shadow-xs transition-shadow">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-foreground leading-tight mt-0.5">18</div>
              </div>
            </div>
            <button 
              onClick={() => setActiveSubTab('My Performance')}
          ...
          <div className="bg-card border border-border rounded-2xl p-4 shadow-2xs flex flex-col justify-between hover:shadow-xs transition-shadow">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-foreground leading-tight mt-0.5">5.0</div>
              </div>
            </div>
            <div className="mt-4 flex items-center gap-1.5">
              <div className="flex text-destructive text-xs">★★★★★</div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <div className="w-14 shrink-0">
                          <div className={`font-bold text-[11px] ${isSelected ? 'text-primary' : 'text-primary'}`}>
                            {appt.time}
                          </div>
          ...
          <section className="xl:col-span-4 bg-card border border-border rounded-2xl p-5 shadow-2xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h2 className="text-sm font-bold text-foreground">Current Pet: {activePet.petName}</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="text-xs space-y-1 min-w-0">
                <div className="font-bold text-foreground text-sm">
                  {activePet.breed} <span className="font-normal text-muted-foreground text-xs">• {activePet.age} • {activePet.weight}</span>
                </div>
            ...
            <div className="grid grid-cols-3 gap-2 bg-muted/40/70 p-2.5 rounded-xl text-center border border-border/60">
              <div>
                ...
                <div className="text-xs font-semibold text-foreground mt-0.5 truncate">{activePet.allergies || 'None'}</div>
              </div>
              <div className="border-x border-border/60">
                <div className="text-[10px] text-muted-foreground/70 font-medium">Temperament</div>
                <div className="text-xs font-semibold text-foreground mt-0.5">{activePet.temperament || 'Friendly'}</div>
              </div>
              <div>
                <div className="text-[10px] text-muted-foreground/70 font-medium">Last Groom</div>
                <div className="text-xs font-semibold text-foreground mt-0.5">{activePet.lastGroomDate || 'Apr 14, 2025'}</div>
              </div>
            </div>

            {/* Today's Service Pricing */}
            <div className="space-y-1.5 pt-1">
              <div className="text-[11px] font-bold text-muted-foreground/70 uppercase tracking-wider">Today&apos;s Service</div>
              <div className="flex items-baseline justify-between">
                <div className="text-xs font-bold text-foreground">{activePet.serviceType || activePet.serviceName || 'Full Groom'}</div>
                <div className="text-xs font-bold text-foreground">${(activePet.price ?? 85).toFixed(2)}</div>
              </div>
            ...
            <div className="bg-primary/5/50 border border-primary/20/70 rounded-xl p-3 text-xs space-y-1">
              <div className="font-bold text-foreground text-[11px]">Notes from Owner</div>
            ...
            <div className="space-y-2 pt-1 text-xs">
              <div className="flex items-center justify-between">
                <span className="font-bold text-foreground text-[11px]">Pet Notes (Internal)</span>
                <button 
          ...
          <div className="xl:col-span-4 space-y-4">
            ...
            <section className="bg-card border border-border rounded-2xl p-5 shadow-2xs space-y-4">
              <h2 className="text-sm font-bold text-foreground">Appointment Workflow</h2>
                  ...
                  return (
                    <div key={step.label} className="flex flex-col items-center gap-1.5 z-10">
                      ...
                      <span className={`text-[10px] font-medium ${
                        isCurrent ? 'text-primary font-bold' : isDone ? 'text-foreground font-semibold' : 'text-muted-foreground/70'
                      }`}>
                        {step.label}
                      </span>
                    </div>
              ...
              {/* Status & CTA */}
              <div className="pt-2">
                <div className="text-xs font-bold text-foreground">{activePet.status}</div>
                <div className="text-[11px] text-muted-foreground/70">
                ...
                <button 
                  ...
                  className="mt-3 w-full py-2.5 bg-primary hover:bg-primary/90 active:bg-primary text-white text-xs font-semibold rounded-xl shadow-xs shadow-indigo-200 transition-colors cursor-pointer flex items-center justify-center gap-2"
                >
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="relative w-24 h-24 flex items-center justify-center shrink-0">
                  ...
                  <div className="absolute text-center">
                    <div className="text-sm font-bold text-foreground">3 / 7</div>
                ...
                <div className="space-y-1.5 text-xs flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-foreground text-[11px]">3</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="flex items-center gap-1.5 text-muted-foreground text-[11px]">
                    ...
                    <span className="font-bold text-foreground text-[11px]">2</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="flex items-center gap-1.5 text-muted-foreground text-[11px]">
                    ...
                    <span className="font-bold text-foreground text-[11px]">1</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="flex items-center gap-1.5 text-muted-foreground text-[11px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          ...
          <div className="bg-card border border-border rounded-2xl p-5 shadow-2xs flex flex-col justify-between">
            <div className="space-y-3">
              <h3 className="text-sm font-bold text-foreground">Recent Notes</h3>
                ...
                <div className="pt-2 first:pt-0 space-y-1">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="font-bold text-foreground text-[11px]">Buddy <span className="font-normal text-muted-foreground/70">• 4/14/25</span></span>
                    </div>
                ...
                <div className="pt-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="font-bold text-foreground text-[11px]">Luna <span className="font-normal text-muted-foreground/70">• 5/1/25</span></span>
                    </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-5 shadow-2xs flex flex-col justify-between">
            <div>
              <h3 className="text-sm font-bold text-foreground">Incidents (30 Days)</h3>
              <div className="py-6 flex flex-col items-center justify-center text-center space-y-2">
                <div className="w-10 h-10 rounded-full bg-success/10 text-success flex items-center justify-center">
                  <Check className="w-5 h-5" />
                </div>
                <div className="text-xs font-bold text-foreground">No incidents reported</div>
          ...
          <div className="bg-card border border-border rounded-2xl p-5 shadow-2xs flex flex-col justify-between">
            <div>
              <h3 className="text-sm font-bold text-foreground">Upcoming Time Off</h3>
              <div className="mt-4 flex items-center justify-between p-3 bg-muted/40/70 border border-border/80 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-xs">
                    <div className="font-bold text-foreground leading-tight">May 24, 2025</div>
      ...
      {activeQuickActionModal && (
        <div className="fixed inset-0 z-50 bg-card/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-card rounded-3xl border border-border shadow-2xl max-w-md w-full p-6 space-y-4">
            ...
            {modalSuccessMessage ? (
              <div className="p-4 bg-success/10 border border-success/20 rounded-2xl text-success text-xs font-semibold text-center space-y-1">
              ...
              <div className="space-y-3 text-xs">
                {activeQuickActionModal === 'service' && (
                  <div className="space-y-2">
                    ...
                    <select className="w-full p-2.5 bg-muted/40 border border-border rounded-xl text-xs">
                ...
                {activeQuickActionModal === 'note' && (
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full p-2.5 bg-muted/40 border border-border rounded-xl text-xs"
                    />
                  </div>
                )}
                ...
                {activeQuickActionModal === 'signature' && (
                  <div className="space-y-2">
                    ...
                    <div className="h-24 bg-muted/40 border-2 border-dashed border-border rounded-xl flex items-center justify-center text-muted-foreground/70 text-xs">
                ...
                {activeQuickActionModal === 'timeoff' && (
                  <div className="space-y-2">
                    ...
                    <input type="date" defaultValue="2025-06-01" className="w-full p-2.5 bg-muted/40 border border-border rounded-xl text-xs" />
                    <label className="font-semibold text-foreground pt-1 block">Reason (Optional)</label>
                    <input type="text" placeholder="Vacation / Personal day" className="w-full p-2.5 bg-muted/40 border border-border rounded-xl text-xs" />
                  </div>
                )}
