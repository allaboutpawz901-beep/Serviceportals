        ...
        <div className="animate-fade-in p-6 space-y-6 bg-muted/30 min-h-[500px]">
          ...
          <div className="bg-card border border-border p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="bg-card hover:bg-muted/40 text-foreground border border-border px-3 py-1 text-[11px] text-muted-foreground font-bold cursor-pointer rounded-md flex items-center gap-1.5"
              >
                <Download className="w-3 h-3" /> EXPORT PDF
              </button>
              <button
                onClick={() => alert('Transmitting accounting spreadsheet CSV... Downloaded.')}
                className="bg-black hover:bg-muted text-white border border-border px-3 py-1 text-[11px] text-muted-foreground font-bold cursor-pointer rounded-md flex items-center gap-1.5"
              >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 border border-border divide-x divide-y lg:divide-y-0 divide-black bg-card">
            <div className="p-4 flex flex-col justify-between">
              ...
              <p className="text-lg font-bold tabular-nums tracking-tight text-foreground mt-2">$48,600.00</p>
              <span className="text-[10px] text-success font-bold">+12.4% vs last Q</span>
            </div>
            <div className="p-4 flex flex-col justify-between">
              <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">TOTAL COGS</span>
              <p className="text-lg font-bold tabular-nums tracking-tight text-foreground mt-2">$3,200.00</p>
            ...
            <div className="p-4 flex flex-col justify-between bg-muted/30">
              ...
              <p className="text-lg font-bold tabular-nums tracking-tight text-foreground mt-2">$45,400.00</p>
              <span className="text-[10px] text-success font-bold">93.4% Margin</span>
            </div>
            <div className="p-4 flex flex-col justify-between">
              <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">TOTAL OPEX</span>
              <p className="text-lg font-bold tabular-nums tracking-tight text-foreground mt-2">$22,650.00</p>
            ...
            <div className="p-4 flex flex-col justify-between bg-muted/40">
              ...
              <span className="text-[10px] text-success font-bold">46.8% Net Margin</span>
            </div>
          </div>

          {/* MAIN P&L RECURSIVE TABLE */}
          <div className="bg-card border border-border">
            <div className="bg-muted/40 border-b border-border p-3 tabular-nums font-bold text-xs uppercase flex justify-between">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex justify-between pl-4 py-0.5">
                    ...
                    <span className="font-bold">$42,150.00</span>
                  </div>
                  <div className="flex justify-between pl-4 py-0.5">
                    <span>4020-00 // Walk-In / Add-On Treatments (Nails, Teeth)</span>
                    <span className="font-bold">$4,300.00</span>
                  </div>
                  <div className="flex justify-between pl-4 py-0.5">
                ...
                <div className="border-t-2 border-border pt-3 flex justify-between items-center bg-primary text-primary-foreground p-3 font-semibold text-sm">
                  ...
                  <span className="text-success font-bold">$22,750.00</span>
                </div>
              </div>
      ...
      {activeReportTab === 'balance-sheet' && (
        <div className="animate-fade-in p-6 space-y-6 bg-muted/30 min-h-[500px]">
          <div className="border border-border bg-card p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-xs tabular-nums">
              {/* ASSETS SIDE */}
              <div className="space-y-6">
                <div className=" border-border pb-2 flex justify-between items-end">
                  <h3 className="font-bold text-sm uppercase text-foreground">01 // ACTIVE CURRENT &amp; FIXED ASSETS</h3>
                ...
                <div className="divide-y divide-neutral-200">
                  <div className="py-2.5 flex justify-between">
                    ...
                    <strong className="text-foreground font-bold">$18,450.00</strong>
                  </div>
                  <div className="py-2.5 flex justify-between">
                    <span>1020-00 // Client Escrow Deposits Hold Account</span>
                    <strong className="text-foreground font-bold">$6,780.00</strong>
                  </div>
                  <div className="py-2.5 flex justify-between">
                    <span>1210-00 // Accounts Receivable (Invoiced Balance)</span>
                    <strong className="text-foreground font-bold">$380.00</strong>
                  </div>
                  <div className="py-2.5 flex justify-between">
                    <span>1410-00 // Operating Salon Shampoo Supplies &amp; PO Hold</span>
                    <strong className="text-foreground font-bold">$1,200.00</strong>
                  </div>
                  <div className="py-2.5 flex justify-between">
                    <span>1610-00 // Mobile Groomer Van Equipment Unit #01</span>
                    <strong className="text-foreground font-bold">$45,000.00</strong>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className=" border-border pb-2 flex justify-between items-end">
                  <h3 className="font-bold text-sm uppercase text-foreground">02 // LIABILITIES &amp; SHAREHOLDERS EQUITY</h3>
                  <span className="text-[10px] text-muted-foreground/70">CREDIT BALANCE NATURE</span>
                </div>
                <div className="divide-y divide-neutral-200">
                  <div className="py-2 flex justify-between text-muted-foreground font-bold">
                    <span>[CURRENT LIABILITIES]</span>
                    <span>—</span>
                  </div>
                  <div className="py-2.5 flex justify-between pl-4">
                    <span>2010-00 // Accounts Payable (Operating Bills)</span>
                    <strong className="text-foreground font-bold">$4,686.00</strong>
                  </div>
                  <div className="py-2.5 flex justify-between pl-4">
                    <span>2020-00 // Accrued Sales Taxes Collected</span>
                    <strong className="text-foreground font-bold">$542.00</strong>
                  </div>
                  <div className="py-2 flex justify-between text-muted-foreground font-bold">
                  ...
                  <div className="py-2.5 flex justify-between pl-4">
                    ...
                    <strong className="text-foreground font-bold">$50,000.00</strong>
                  </div>
                  <div className="py-2.5 flex justify-between pl-4">
                    <span>3110-00 // Retained Salon Earnings</span>
                    <strong className="text-foreground font-bold">$16,582.00</strong>
                  </div>
                </div>
                <div className="pt-4 border-t-2 border-border flex justify-between items-center bg-muted/30 p-3">
      ...
      {activeReportTab === 'trial-balance' && (
        <div className="animate-fade-in p-6 bg-muted/30 min-h-[500px]">
          <div className="border border-border bg-card p-6">
              ...
              <table className="w-full text-left text-[13px] text-foreground border-collapse">
                ...
                <tbody className="divide-y divide-border font-medium">
                  <tr>
                    ...
                    <td className="p-3 border-r border-border text-right font-bold">$18,450.00</td>
            ...
            <div className="bg-success/10 border border-success/20 p-3 mt-4 text-[10px] font-bold text-success uppercase flex items-center justify-between">
        ...
        <div className="animate-fade-in p-6 bg-muted/30 min-h-[500px] space-y-6">
          <div className="bg-card border border-border p-6 space-y-4">
            <div className="flex items-center justify-between border-b border-border pb-4">
              ...
              <span className="text-success font-semibold text-xs tabular-nums">+12.8% OVER TARGET</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-[13px] text-foreground pt-4">
              <div className="border border-border p-3 bg-card">
                <span className="text-[9px] uppercase font-bold text-muted-foreground/70">AVERAGE TICKET SIZE</span>
                <p className="text-base font-bold mt-1">$128.50</p>
              </div>
              <div className="border border-border p-3 bg-card">
                <span className="text-[9px] uppercase font-bold text-muted-foreground/70">DAILY CHECKOUT COUNT</span>
                <p className="text-base font-bold mt-1">28 Checkout Sessions</p>
              </div>
              <div className="border border-border p-3 bg-card">
                <span className="text-[9px] uppercase font-bold text-muted-foreground/70">SATURDAY CONVERSION</span>
                <p className="text-base font-bold mt-1">98.2% immediate settlement</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {activeReportTab === 'disputes-chargebacks' && (
        <div className="animate-fade-in p-6 bg-muted/30 min-h-[500px] grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 bg-card border border-border flex flex-col">
            <div className="bg-muted/40 border-b border-border p-3 tabular-nums font-bold text-xs uppercase flex justify-between items-center">
              ...
              {disputesList.map(disp => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold">{disp.id} {"//"} {disp.client}</span>
                    <span className="text-destructive font-bold">${disp.amount.toFixed(2)}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-[10px] text-muted-foreground/70 font-medium">
                    ...
                    <span className={`text-[9px] font-bold border px-2 py-0.5 uppercase ${
              ...
              return (
                <div className="p-4 space-y-4">
                  <div className="flex items-center justify-between border-b border-border pb-3">
                    <div>
                      <span className="text-[11px] bg-primary text-primary-foreground px-1.5 py-0.5 font-bold uppercase">DISPUTE DETAIL // {disp.id}</span>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-[12px]">
                    <div>
                      <span className="text-[9px] text-muted-foreground/70 font-bold uppercase">REASON CODE / CLAIM</span>
                      <p className="font-bold text-foreground mt-1">{disp.reason}</p>
                    </div>
                    <div>
                      <span className="text-[9px] text-muted-foreground/70 font-bold uppercase">GATEWAY CASE DEADLINE</span>
                      <p className="font-bold text-destructive mt-1">{disp.deadline}</p>
                    </div>
                  </div>
                  ...
                  {disp.status === 'NEEDS_RESPONSE' ? (
                    <form onSubmit={handleDisputeSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        className="bg-primary text-primary-foreground hover:bg-primary/90 border border-border px-4 py-2 text-[12px] uppercase tracking-wider font-bold transition-colors cursor-pointer rounded-md w-full"
                      >
                        TRANSMIT EVIDENCE TO STRIPE MERCHANT PORTAL
                      </button>
                    </form>
                  ) : (
                    <div className="bg-success/10 border border-success/20 p-3 flex items-center justify-center text-[12px] text-success font-bold uppercase gap-2">
