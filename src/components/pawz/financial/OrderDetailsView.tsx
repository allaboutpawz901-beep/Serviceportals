      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border border-border p-4 bg-card gap-4">
        <div>
          <div className="flex items-center gap-2 text-[10px] tabular-nums uppercase tracking-widest text-muted-foreground">
            <button 
              ...
              className="hover:underline flex items-center gap-1 text-foreground font-bold cursor-pointer"
            >
              <ArrowLeft className="w-3 h-3" />
              <span>ORDERS</span>
            </button>
            <span>{'//'}</span>
            <span className="text-foreground font-bold">#ORD-2025-1048</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button 
            ...
            className="px-3 py-1.5 border border-border bg-card hover:bg-accent/50 font-bold text-xs uppercase flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <button 
            ...
            className="px-3 py-1.5 border border-border bg-primary text-primary-foreground hover:bg-primary/90 font-bold text-xs uppercase flex items-center gap-1.5 cursor-pointer"
          >
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="border border-border bg-card">
            <div className="p-3.5 border-b border-border flex items-center justify-between bg-muted/30">
              ...
              <span className="text-[10px] tabular-nums text-foreground font-bold">BIN ALLOCATED 100%</span>
            </div>

            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse tabular-nums">
                <thead>
                  <tr className="bg-card border-b border-border text-[11px] uppercase font-bold text-muted-foreground">
                ...
                <tbody className="divide-y divide-border text-xs">
                  <tr className="hover:bg-accent/50">
                    ...
                    <td className="p-3 border-r border-border">
                      <p className="font-bold font-sans text-foreground">Organic Blueberry Facial Foam Wash (8 oz)</p>
                      <p className="text-[10px] text-muted-foreground">SKU: AAP-SHP-001 · Pawz Botanicals</p>
                    </td>
                    <td className="p-3 text-center border-r border-border font-bold">2</td>
                    <td className="p-3 text-right border-r border-border">$24.00</td>
                    <td className="p-3 text-right border-r border-border font-bold">$48.00</td>
                  ...
                  <tr className="hover:bg-accent/50">
                    ...
                    <td className="p-3 border-r border-border">
                      <p className="font-bold font-sans text-foreground">Professional Undercoat De-shedding Rake</p>
                      <p className="text-[10px] text-muted-foreground">SKU: AAP-TLS-014 · GroomPro Elite</p>
                    </td>
                    <td className="p-3 text-center border-r border-border font-bold">1</td>
                    <td className="p-3 text-right border-r border-border">$32.50</td>
                    <td className="p-3 text-right border-r border-border font-bold">$32.50</td>
                    <td className="p-3 text-right">
                      <span className="px-1.5 py-0.5 border border-border bg-muted/40 text-[10px] font-bold">
                        BIN T-12
                      </span>
                  ...
                  <tr className="hover:bg-accent/50">
                    ...
                    <td className="p-3 border-r border-border">
                      <p className="font-bold font-sans text-foreground">Natural Calming Hemp Treats (30 count)</p>
                    ...
                    <td className="p-3 text-right border-r border-border font-bold">$18.00</td>
                    <td className="p-3 text-right">
                      <span className="px-1.5 py-0.5 border border-border bg-muted/40 text-[10px] font-bold">
                        BIN F-02
                      </span>
            ...
            <div className="border-t border-border grid grid-cols-1 md:grid-cols-2 bg-card">
              <div className="p-4 border-b md: md:border-r border-border space-y-2">
                <p className="font-bold text-[10px] uppercase tracking-wider text-muted-foreground tabular-nums">Payment Ledger Settlement</p>
                <div className="flex items-center gap-2 text-[12px]">
                  <CreditCard className="w-4 h-4 text-foreground" />
                  <span className="font-bold text-foreground">Visa ending 4242</span>
                  <span className="px-1 py-0.2 border border-border text-[10px] uppercase font-bold">AUTH #TXN-908122</span>
                </div>
              ...
              <div className="p-4 space-y-1.5 text-[12px]">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-foreground">$98.50</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Shipping (USPS Ground):</span>
                  <span className="font-bold text-foreground">$8.50</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Sales Tax (TX 8.25%):</span>
                  <span className="font-bold text-foreground">$8.13</span>
                </div>
          ...
          <div className="border border-border bg-card p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-[12px]">
              <div className="border border-border p-2 bg-primary text-primary-foreground">
                <p className="text-[10px] font-bold uppercase text-muted-foreground/50">01. Placed</p>
                <p className="font-bold mt-0.5">10:14 AM</p>
              </div>
              <div className="border border-border p-2 bg-primary text-primary-foreground">
                <p className="text-[10px] font-bold uppercase text-muted-foreground/50">02. Paid</p>
                <p className="font-bold mt-0.5">10:15 AM</p>
              </div>
              <div className="border border-border p-2 bg-muted/40 text-foreground">
                <p className="text-[10px] font-bold uppercase text-foreground">03. Packed</p>
                <p className="font-bold mt-0.5">11:30 AM</p>
              </div>
              <div className="border border-dashed border-border p-2 bg-card text-muted-foreground">
                <p className="text-[10px] font-bold uppercase">04. Pickup</p>
                <p className="font-bold mt-0.5">16:30 Cutoff</p>
              </div>
            </div>

            <div className="border-t border-border pt-3 space-y-2 text-xs tabular-nums">
          ...
          <div className="border border-border bg-card p-4 space-y-3">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className="px-2 py-1 border border-border bg-muted/30 text-[10px] font-bold uppercase hover:bg-black hover:text-white transition-colors cursor-pointer"
              >
                Preset: Ready
              </button>
              <button 
            ...
            <textarea 
              ...
              className="w-full p-2 text-xs border border-border focus:outline-none resize-none tabular-nums"
            />
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-muted-foreground tabular-nums">SMS to (214) 555-0198 + Email copy</span>
              <button 
                onClick={handleSend}
                className="px-3 py-1.5 bg-primary text-primary-foreground text-xs font-bold uppercase flex items-center gap-1 cursor-pointer"
              >
            ...
            {sentNotice && (
              <p className="text-xs font-bold text-foreground tabular-nums">✓ Dispatch note logged and sent!</p>
            )}
          </div>
        </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="border border-border bg-card p-4 space-y-3">
            <div className="flex items-center justify-between border-b border-border pb-2">
              ...
              <span className="px-1.5 py-0.2 border border-border bg-primary text-primary-foreground text-[10px] font-bold">VIP 2</span>
            </div>
            <div>
              <p className="text-base font-bold text-foreground uppercase">Sarah Johnson</p>
              <p className="text-[10px] tabular-nums text-muted-foreground">Account: #AAP-CUS-0894</p>
            </div>
            <div className="p-2 border border-border bg-muted/30 text-xs tabular-nums space-y-1">
              <p className="font-bold text-foreground">Registered Pets:</p>
              <p>• Buddy (Golden Retriever)</p>
              <p>• Luna (French Bulldog)</p>
            </div>
            <div className="text-xs tabular-nums space-y-1 text-foreground">
          ...
          <div className="border border-border bg-card p-4 space-y-3">
            <div className="flex items-center justify-between border-b border-border pb-2">
              ...
              <span className="text-[10px] tabular-nums text-foreground font-bold">USPS 4X6</span>
            </div>
            <div className="p-2 border border-border bg-muted/30 text-xs tabular-nums">
              <p className="font-bold text-foreground uppercase">Sarah Johnson</p>
            ...
            <div className="text-xs tabular-nums space-y-1">
              ...
              <p className="font-bold text-foreground">USPS Ground Advantage (Commercial)</p>
              <p className="text-muted-foreground uppercase text-[10px] mt-2">Tracking #:</p>
              <p className="font-bold text-foreground bg-muted/40 p-1 border border-border select-all">
