    ...
    <form onSubmit={handleSave} className="space-y-6 text-xs">
      <div className="bg-card p-5 rounded-2xl border border-border/90 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h2 className="text-xl font-bold text-foreground">Booking &amp; Operations Rules</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-card p-5 rounded-2xl border border-border/90 shadow-2xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            <h3 className="font-bold text-foreground text-sm">Online Self-Booking</h3>
        ...
        <div className="bg-card p-5 rounded-2xl border border-border/90 shadow-2xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            <h3 className="font-bold text-foreground text-sm">Deposits &amp; Cancellation Fee</h3>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 rounded-xl bg-muted/40 border border-border">
              <div>
                <p className="font-bold text-foreground">Require Upfront Deposit</p>
        ...
        <div className="bg-card p-5 rounded-2xl border border-border/90 shadow-2xs space-y-3 md:col-span-2">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-foreground text-sm">Smart Waitlist &amp; Auto-Fill Dispatch</h3>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
