    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-card p-5 border border-border">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 text-[10px] tabular-nums font-bold uppercase bg-primary text-primary-foreground">
              Academy OS
            </span>
            <span className="text-xs tabular-nums text-muted-foreground">v3.2 Enterprise</span>
          </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 py-2 bg-black hover:bg-muted text-white text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-card border border-border p-4">
          ...
          <div className="text-2xl tabular-nums font-bold text-foreground">{courses.length}</div>
        ...
        <div className="bg-card border border-border p-4">
          ...
          <div className="text-2xl tabular-nums font-bold text-foreground">16 Trainees</div>
        ...
        <div className="bg-card border border-border p-4">
          ...
          <div className="text-2xl tabular-nums font-bold text-foreground">91.4%</div>
          <div className="text-[10px] tabular-nums text-muted-foreground mt-1">
        ...
        <div className="bg-card border border-border p-4">
          ...
          <div className="text-2xl tabular-nums font-bold text-success">96.8%</div>
          <div className="text-[10px] tabular-nums text-muted-foreground mt-1">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-center justify-between bg-card p-3 border border-border">
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 text-xs border border-border focus:border-border focus:outline-hidden tabular-nums"
              />
            </div>
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <select
                ...
                className="text-xs border border-border px-2.5 py-1.5 bg-card tabular-nums focus:border-border focus:outline-hidden cursor-pointer"
              >
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <span className="px-2 py-0.5 text-[10px] tabular-nums font-bold uppercase bg-muted/40 text-foreground border border-border">
                      {course.category}
                    </span>
                    <span
                      className={`text-[10px] tabular-nums font-bold uppercase px-2 py-0.5 border ${
                  ...
                  <h3 className="font-bold text-sm text-foreground group-hover:underline line-clamp-2">
                    {course.title}
                  </h3>
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-4 pt-3 border-t border-border text-center tabular-nums text-xs">
                    <div className="bg-muted/40 p-1.5 border border-border">
                      <div className="text-[10px] text-muted-foreground uppercase">Duration</div>
                      <div className="font-bold text-foreground">{course.totalDuration}</div>
                    </div>
                    <div className="bg-muted/40 p-1.5 border border-border">
                      <div className="text-[10px] text-muted-foreground uppercase">Lessons</div>
                      <div className="font-bold text-foreground">{course.lessons.length}</div>
                    </div>
                    <div className="bg-muted/40 p-1.5 border border-border">
                      <div className="text-[10px] text-muted-foreground uppercase">Pass Rate</div>
                      <div className="font-bold text-foreground">{course.completionRate}%</div>
                    </div>
                  </div>
      ...
      {activeSubTab === 'trainees' && (
        <div className="bg-card border border-border overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-border text-xs tabular-nums">
                ...
                <tr key={trainee.id} className="hover:bg-muted/40/80 transition-colors">
                  <td className="p-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      />
                      <div>
                        <div className="font-bold text-foreground">{trainee.staffName}</div>
                  ...
                  <td className="p-3 w-40">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold">{trainee.progressPercent}%</span>
                    </div>
                  </td>
                  <td className="p-3 font-bold text-foreground">{trainee.overallScore}%</td>
                  <td className="p-3">
                    <span
                  ...
                  <td className="p-3 text-right">
                    <button
                      ...
                      className="px-2 py-1 text-[10px] font-bold uppercase bg-card border border-border hover:border-border text-foreground cursor-pointer transition-colors"
                    >
                      Assign Course
                    </button>
                  </td>
      ...
      {activeSubTab === 'certifications' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-card border border-border p-5 space-y-3">
            ...
            <h3 className="font-bold text-sm text-foreground uppercase">Certified Canine First Responder</h3>
            ...
            <div className="pt-2 border-t border-border flex items-center justify-between text-xs tabular-nums">
              ...
              <span className="font-bold text-foreground">16 Active Staff</span>
            </div>
            <button
              onClick={() => alert('Certificate template exported as PDF')}
              className="w-full py-1.5 bg-muted/40 hover:bg-black hover:text-white text-foreground border border-border text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
            >
          ...
          <div className="bg-card border border-border p-5 space-y-3">
            ...
            <h3 className="font-bold text-sm text-foreground uppercase">Master Scissor Stylist Badge</h3>
            <p className="text-xs text-muted-foreground leading-relaxed tabular-nums">
              Awarded upon passing the Asian Fusion &amp; Teddy Bear Face practical review with 90%+ score.
            </p>
            <div className="pt-2 border-t border-border flex items-center justify-between text-xs tabular-nums">
              <span className="text-muted-foreground">Holders:</span>
              <span className="font-bold text-foreground">4 Senior Stylists</span>
            </div>
            <button
              onClick={() => alert('Certificate template exported as PDF')}
              className="w-full py-1.5 bg-muted/40 hover:bg-black hover:text-white text-foreground border border-border text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
          ...
          <div className="bg-card border border-border p-5 space-y-3">
            ...
            <h3 className="font-bold text-sm text-foreground uppercase">OSHA Salon Safety &amp; Disinfection</h3>
            <p className="text-xs text-muted-foreground leading-relaxed tabular-nums">
        ...
        <div className="space-y-4">
          <div className="bg-card border border-border p-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <div>
                <h3 className="font-bold text-sm text-foreground uppercase">Mandatory Staff Compliance Audit</h3>
                <p className="text-xs text-muted-foreground tabular-nums">All About Pawz - Frisco &amp; Plano Salons</p>
              </div>
              <span className="px-2.5 py-1 text-xs tabular-nums font-bold uppercase bg-success/10 text-success border border-success/20">
                100% Audit Ready
              </span>
            </div>

            <div className="mt-4 space-y-3 tabular-nums text-xs">
              <div className="flex items-center justify-between p-3 bg-muted/40 border border-border">
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-success" />
                  <div>
                    <div className="font-bold text-foreground">Safety Data Sheets (SDS) Review</div>
              ...
              <div className="flex items-center justify-between p-3 bg-muted/40 border border-border">
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-success" />
                  <div>
                    <div className="font-bold text-foreground">First Aid Station &amp; Eye Wash Station Drill</div>
              ...
              <div className="flex items-center justify-between p-3 bg-muted/40 border border-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-foreground">Pet CPR Refresher Recertification</div>
                    <div className="text-[11px] text-muted-foreground">1 bather staff due for renewal within 14 days</div>
                  </div>
                </div>
                <span className="text-[11px] font-bold text-warning">Due May 28, 2025</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {isAddCourseModalOpen && (
        <div className="fixed inset-0 z-50 bg-foreground/[0-9]0 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-card max-w-lg w-full p-6 border border-border shadow-2xl space-y-4">
            ...
            <form onSubmit={handleCreateCourse} className="space-y-4 text-xs tabular-nums">
              <div>
                <label className="block font-bold uppercase text-foreground mb-1">Course Title *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold uppercase text-foreground mb-1">Category</label>
                  <select
                ...
                <div>
                  <label className="block font-bold uppercase text-foreground mb-1">Skill Level</label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold uppercase text-foreground mb-1">Estimated Duration</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block font-bold uppercase text-foreground mb-1">Instructor / Lead</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block font-bold uppercase text-foreground mb-1">Course Description</label>
                <textarea
                  rows={3}
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-border">
                <button
                  type="button"
                  onClick={() => setIsAddCourseModalOpen(false)}
                  className="px-3.5 py-2 border border-border hover:border-border text-foreground text-xs font-bold uppercase cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-4 py-2 bg-black hover:bg-muted text-white text-xs font-bold uppercase tracking-wider cursor-pointer"
                >
                  Publish to Academy
                </button>
              </div>
      ...
      {isLessonPreviewOpen && selectedCourse && (
        <div className="fixed inset-0 z-50 bg-foreground/[0-9]0 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-card max-w-3xl w-full p-6 border border-border shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            {/* Lessons Syllabus */}
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground mb-2 tabular-nums">
                Curriculum Modules ({selectedCourse.lessons.length} Lessons)
              </h4>
              <div className="divide-y divide-border border border-border tabular-nums text-xs">
                {selectedCourse.lessons.map((lesson, idx) => (
                  <div
                    key={lesson.id}
                    onClick={() => setActiveLesson(lesson)}
                    className={`p-3 flex items-center justify-between cursor-pointer transition-colors ${
                      activeLesson?.id === lesson.id ? 'bg-muted/40 font-bold' : 'hover:bg-muted/40'
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-5 h-5 bg-primary text-primary-foreground text-[10px] font-bold flex items-center justify-center">
                        {idx + 1}
                      </span>
                      <div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-border">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-muted/40 hover:bg-black hover:text-white text-foreground border border-border text-xs font-bold uppercase transition-colors cursor-pointer"
              >
              ...
              <button
                onClick={() => setIsLessonPreviewOpen(false)}
                className="px-4 py-1.5 bg-primary text-primary-foreground text-xs font-bold uppercase cursor-pointer"
              >
                Close Curriculum
              </button>
            </div>
