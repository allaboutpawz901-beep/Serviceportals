      ...
      <div className="w-full bg-card border-b border-border overflow-x-auto select-none">
        <div className="flex items-center min-w-max">
          <div className="px-3 py-2 bg-muted/40 border-r border-border flex items-center gap-2">
            ...
            <span className="tabular-nums text-[11px] uppercase tracking-widest text-foreground font-bold">MODULE // INVENTORY OMS</span>
          </div>
      ...
      <div className="p-5 max-w-4xl space-y-5 tabular-nums text-xs">
        <div className="border-2-black bg-card p-5 space-y-4">
          <div className="flex items-center justify-between border-b border-border pb-2">
            <span className="font-bold uppercase text-foreground">PRODUCT IDENTIFIERS &amp; MERCHANDISE DETAILS</span>
        ...
        <div className="border-2-black bg-card p-5 space-y-4">
          <div className="flex items-center justify-between border-b border-border pb-2">
            <span className="font-bold uppercase text-foreground">PRICING, COST &amp; INVENTORY AUDITING</span>
            <span className="text-[9px] bg-primary text-primary-foreground px-1.5 py-0.2 font-bold">GROSS MARGIN: 52.1%</span>
          </div>
          ...
          <div className="pt-3 border-t border-border space-y-2">
            <label className="flex items-center justify-between p-2 border border-border cursor-pointer bg-card">
              <div>
                <div className="font-bold">Track Perpetual Stock Ledger</div>
            ...
            <label className="flex items-center justify-between p-2 border border-border cursor-pointer bg-card">
              <div>
                <div className="font-bold">Taxable Retail Merchandise</div>
