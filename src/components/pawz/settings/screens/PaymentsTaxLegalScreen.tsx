    ...
    <div className="w-full bg-card text-foreground font-sans antialiased text-xs">
      ...
      <div className="p-6 border-b border-border">
        ...
        <div className="flex items-center gap-1 mt-6 border-b border-border -mb-6">
          ...
          <button onClick={() => onNavigateScreen?.('booking-rules')} className="px-4 py-2 bg-muted/40 hover:bg-muted text-foreground tabular-nums text-xs font-bold border-t border-l border-r border-border uppercase cursor-pointer">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="border-2 border-border p-5 bg-card">
            <div className="flex items-start justify-between border-b border-border pb-3 mb-4">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 bg-primary text-primary-foreground tabular-nums font-bold flex items-center justify-center text-xs">A</div>
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-base uppercase">SECTION A: CORPORATE LEGAL ENTITY &amp; REGISTRATION</h3>
                    <span className="bg-primary text-primary-foreground tabular-nums text-[10px] px-1.5 py-0.2 font-bold uppercase">VERIFIED ENTITY</span>
                  </div>
                  <div className="text-xs tabular-nums text-muted-foreground">TX SOS FILE: 0804921940 // REGISTRATION STATUS: ACTIVE GOOD STANDING</div>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <button onClick={() => showToast('SOS DIGITAL CERTIFICATE EXPORTED')} className="border border-border px-2 py-1 text-xs tabular-nums font-bold hover:bg-muted/40 uppercase cursor-pointer">[EXPORT SOS CERT]</button>
                <button onClick={() => showToast('LEGAL ENTITY REVISION ACTIVE')} className="bg-primary text-primary-foreground px-2 py-1 text-xs tabular-nums font-bold hover:bg-muted uppercase cursor-pointer">[EDIT FILING]</button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs tabular-nums">
              <div className="space-y-1">
                ...
                <p className="font-bold text-sm">All About Pawz Holdings LLC</p>
              ...
              <div className="space-y-1">
                ...
                <p className="font-bold">DOMESTIC LIMITED LIABILITY COMPANY</p>
              ...
              <div className="space-y-1">
                ...
                <p className="font-bold text-sm">XX-XXX9812</p>
            ...
            <div className="mt-4 pt-3 border-t border-border bg-muted/30 p-3 tabular-nums text-xs">
              <div className="flex items-center justify-between mb-2">
                <span className="font-bold uppercase text-[11px] flex items-center gap-2">
                  <span className="w-2 h-2 bg-black inline-block"></span>
                  COMMERCIAL GENERAL LIABILITY &amp; GROOMING BAILMENT INSURANCE
                </span>
                <span className="bg-primary text-primary-foreground text-[9px] px-1.5 py-0.5 font-bold uppercase">STATUS: CURRENT</span>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-[11px]">
                <div>
                  <span className="text-muted-foreground block text-[9px] uppercase">UNDERWRITER / POLICY #</span>
                  <span className="font-bold">Lloyd&apos;s Underwriters #POL-VET-88390</span>
                </div>
                <div>
                  <span className="text-muted-foreground block text-[9px] uppercase">COVERAGE LIMITS</span>
                  <span className="font-bold">$2,000,000 Agg / $1,000,000 Occ</span>
                </div>
                <div>
                  <span className="text-muted-foreground block text-[9px] uppercase">POLICY EXPIRATION</span>
                  <span className="font-bold">Jan 15, 2026 (Auto-Renew)</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-2 border-border p-5 bg-card">
            <div className="flex items-start justify-between border-b border-border pb-3 mb-4">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 bg-primary text-primary-foreground tabular-nums font-bold flex items-center justify-center text-xs">B</div>
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-base uppercase">SECTION B: MULTI-JURISDICTION SALES TAX ENGINE</h3>
                    <span className="border border-border tabular-nums text-[10px] px-1.5 py-0.2 uppercase bg-muted/40">TX COMPTROLLER</span>
                  </div>
                  <div className="text-xs tabular-nums text-muted-foreground">SALES &amp; USE TAX PERMIT: #32084918231 // FILING FREQUENCY: MONTHLY ELECTRONIC (EDI)</div>
                </div>
              </div>
              <button onClick={() => showToast('RE-VALIDATED NEXUS WITH TEXAS STATE COMPTROLLER')} className="border border-border px-2 py-1 text-xs tabular-nums font-bold hover:bg-muted/40 uppercase cursor-pointer">[RE-VALIDATE NEXUS]</button>
            </div>

            <div className="mb-4">
              <div className="text-xs tabular-nums uppercase text-muted-foreground mb-2 font-bold">TAX NEXUS BY OPERATING FACILITY</div>
              <div className="border border-border divide-y divide-border tabular-nums text-xs">
                <div className="p-2.5 bg-muted/40 font-bold grid grid-cols-12 gap-2 text-[10px] uppercase">
                ...
                <div className="p-2.5 bg-card grid grid-cols-12 gap-2 items-center">
                  <div className="col-span-4 font-bold">FRISCO MAIN HQ<span className="block text-[10px] text-muted-foreground font-normal">COLLIN COUNTY</span></div>
                  ...
                  <div className="col-span-2 text-right font-bold flex items-center justify-end gap-1.5"><span>8.25%</span><span className="text-[9px] bg-primary text-primary-foreground px-1 py-0.2">ACTIVE</span></div>
                </div>
                <div className="p-2.5 bg-card grid grid-cols-12 gap-2 items-center">
                  <div className="col-span-4 font-bold">PLANO WEST BRANCH<span className="block text-[10px] text-muted-foreground font-normal">DALLAS / COLLIN COUNTY</span></div>
                  <div className="col-span-2 text-right">6.25%</div>
                  <div className="col-span-2 text-right">0.00%</div>
                ...
                <div className="p-2.5 bg-card grid grid-cols-12 gap-2 items-center">
                  <div className="col-span-4 font-bold">MOBILE VAN FLEET<span className="block text-[10px] text-muted-foreground font-normal">DESTINATION SOURCED</span></div>
                  <div className="col-span-2 text-right">6.25%</div>
                  <div className="col-span-2 text-right">0.00%</div>
                  <div className="col-span-2 text-right">Dynamic / ZIP</div>
                  <div className="col-span-2 text-right font-bold flex items-center justify-end gap-1.5"><span>8.25%*</span><span className="text-[9px] bg-muted border border-border px-1 py-0.2">GEO</span></div>
                </div>
              </div>
            </div>

            <div className="border border-border p-3 bg-muted/30 tabular-nums text-xs">
              <div className="font-bold uppercase text-[11px] mb-2">SERVICE &amp; MERCHANDISE TAX EXEMPTION RULES</div>
              <div className="space-y-2 text-muted-foreground text-[11px]">
                <div className="flex items-start justify-between border-b border-border pb-1">
                  ...
                  <span className="font-bold text-foreground">TAXABLE (Texas Admin Code Rule §3.356 Pet Care)</span>
                </div>
                <div className="flex items-start justify-between border-b border-border pb-1">
                  <span>• RETAIL GOODS (SHAMPOOS, LEASHES, SUPPLEMENTS)</span>
                  <span className="font-bold text-foreground">TAXABLE 8.25% Standard Tangible Personal Property</span>
                </div>
                <div className="flex items-start justify-between">
                  <span>• VETERINARY PRESCRIBED MEDICATED DIPS</span>
                  <span className="font-bold text-foreground">TAX-EXEMPT (Requires uploaded Vet Rx on record)</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-2 border-border p-5 bg-card">
            <div className="flex items-center justify-between border-b border-border pb-3 mb-4">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 bg-primary text-primary-foreground tabular-nums font-bold flex items-center justify-center text-xs">C</div>
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-base uppercase">SECTION C: STATUTORY WAIVERS, SIGN-OFFS &amp; VACCINE ENFORCEMENT</h3>
                    <span className="bg-primary text-primary-foreground tabular-nums text-[10px] px-1.5 py-0.2 font-bold uppercase">COMPLIANCE MANDATE</span>
                  </div>
                  <div className="text-xs tabular-nums text-muted-foreground">TX HEALTH &amp; SAFETY CODE CH. 826 // DIGITAL SIGNATURE RETENTION GOVERNANCE</div>
                </div>
              </div>
              <button onClick={() => showToast('WAIVER WORDING UPDATE WIZARD ACTIVE')} className="bg-primary text-primary-foreground px-3 py-1 text-xs tabular-nums font-bold hover:bg-muted uppercase cursor-pointer">[UPDATE WAIVER TEMPLATE]</button>
            </div>

            <div className="space-y-3 tabular-nums text-xs">
              <div className="border border-border p-3 bg-muted/30">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold uppercase text-foreground text-[11px]">TEXAS HEALTH &amp; SAFETY CODE CHAPTER 826 MANDATE</span>
                  <span className="bg-primary text-primary-foreground px-1.5 py-0.5 text-[9px] font-bold uppercase">STRICT ENFORCEMENT</span>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="border border-border p-3 bg-card space-y-1">
                  ...
                  <p className="font-bold text-sm">V4.2-REV2025</p>
                ...
                <div className="border border-border p-3 bg-card space-y-1">
                  ...
                  <p className="font-bold text-sm">7 YEARS VAULT RETENTION</p>
        ...
        <div className="space-y-6">
          ...
          <div className="border-2 border-border p-4 bg-card">
            <div className="flex items-center justify-between border-b border-border pb-2 mb-3">
              <h4 className="font-bold text-xs uppercase tabular-nums tracking-wider">TAX FILING CALENDAR</h4>
            ...
            <div className="space-y-2 tabular-nums text-xs">
              <div className="border border-border p-2.5 bg-muted/30 flex items-center justify-between">
                <div>
                  <div className="font-bold text-xs text-foreground">TX COMPTROLLER 01-2025</div>
                  <div className="text-[10px] text-muted-foreground">DUE: FEB 20, 2025 // EDI #TX-8821</div>
                </div>
                <span className="bg-primary text-primary-foreground text-[10px] px-1.5 py-0.5 font-bold">FILED</span>
              </div>
              
              <div className="border border-border p-2.5 bg-muted/30 flex items-center justify-between">
                <div>
                  <div className="font-bold text-xs text-foreground">TX COMPTROLLER 02-2025</div>
                  <div className="text-[10px] text-muted-foreground">DUE: MAR 20, 2025 // EDI PENDING</div>
                </div>
                <span className="border border-border text-[10px] px-1.5 py-0.5 font-bold uppercase bg-card">UPCOMING</span>
              </div>

              <div className="border border-border p-2.5 bg-muted/30 flex items-center justify-between">
                <div>
                  <div className="font-bold text-xs text-foreground">IRS 941 (Q1 PAYROLL TAX)</div>
                  <div className="text-[10px] text-muted-foreground">DUE: APR 30, 2025 // EFTPS</div>
                </div>
                <span className="border border-border text-[10px] px-1.5 py-0.5 font-bold uppercase bg-card">SCHEDULED</span>
              </div>
            </div>
          </div>
          ...
          <div className="border-2 border-border p-4 bg-card">
            <div className="flex items-center justify-between border-b border-border pb-2 mb-3">
              <h4 className="font-bold text-xs uppercase tabular-nums tracking-wider">AUDIT LOG &amp; COMPLIANCE</h4>
            ...
            <div className="space-y-2 tabular-nums text-xs">
              <div className="p-2 border border-border bg-muted/30">
                ...
                <div className="font-bold mt-1 text-[11px] text-foreground">Rabies verification enforced on 18 check-ins</div>
              </div>
              <div className="p-2 border border-border bg-muted/30">
                ...
                <div className="font-bold mt-1 text-[11px] text-foreground">Waiver version updated to V4.2-REV2025</div>
              </div>
              <div className="p-2 border border-border bg-muted/30">
                ...
                <div className="font-bold mt-1 text-[11px] text-foreground">Lloyd&apos;s Policy #POL-VET-88390 renewed</div>
              </div>
            </div>
          </div>
          ...
          <div className="border-2 border-border p-4 bg-muted/30">
            <div className="flex items-center justify-between border-b border-border pb-2 mb-3">
              <h4 className="font-bold text-xs uppercase tabular-nums tracking-wider">EXPORT LEGAL DOSSIER</h4>
              <span className="text-[10px] tabular-nums text-muted-foreground">SECURE ARCHIVE</span>
            </div>
            <p className="text-xs tabular-nums text-muted-foreground mb-3">Download complete corporate binder including IRS SS-4, Texas SOS filing certificates, and insurance binders.</p>
            <button 
              onClick={() => showToast('EXPORTING DOSSIER BINDER .ZIP')}
              className="w-full bg-primary text-primary-foreground py-2 text-xs tabular-nums uppercase font-bold hover:bg-muted cursor-pointer"
            >
