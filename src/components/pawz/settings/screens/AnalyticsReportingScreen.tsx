...
export const AnalyticsReportingScreen: React.FC<ScreenProps> = ({
  ...
  return (
    <div className="w-full bg-card text-foreground font-sans antialiased text-xs">
      ...
      <div className="w-full bg-card border-b border-border p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2 tabular-nums text-[10px] text-muted-foreground">
            ...
            <span className="text-foreground font-bold">ANALYTICS &amp; EXECUTIVE REPORTING</span>
            <span className="text-foreground font-bold">&gt;&gt;</span>
            <span className="bg-primary text-primary-foreground px-1 text-[9px] font-bold">SUPER_ADMIN L0</span>
          </div>
          <div className="flex items-baseline gap-2">
            <h1 className="font-bold text-lg md:text-xl tracking-tight uppercase text-foreground">BUSINESS OPS TELEMETRY</h1>
      ...
      {/* KPI TELEMETRY STRIP */}
      <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 border-b border-border bg-card tabular-nums text-xs">
        {/* METRIC 01 */}
        <div className="p-3 border-r border-b lg: border-border flex flex-col justify-between">
          <div className="flex items-center justify-between text-[10px] text-muted-foreground uppercase font-bold">
            ...
            <span className="text-foreground font-bold">REV.01</span>
          </div>
          <div className="my-2">
            <div className="text-lg md:text-xl font-bold tracking-tight text-foreground">$58,490.00</div>
          </div>
          <div className="flex items-center gap-1 tabular-nums text-[10px]">
            <span className="bg-primary text-primary-foreground px-1 font-bold">+18.4%</span>
        ...
        <div className="p-3 border-r border-b lg: border-border flex flex-col justify-between">
          <div className="flex items-center justify-between text-[10px] text-muted-foreground uppercase font-bold">
            ...
            <span className="text-foreground font-bold">VOL.02</span>
          </div>
          <div className="my-2">
            <div className="text-lg md:text-xl font-bold tracking-tight text-foreground">412</div>
          </div>
          <div className="flex items-center gap-1 tabular-nums text-[10px] text-muted-foreground">
            <span className="text-foreground font-bold">GROOMS LOGGED</span>
        ...
        <div className="p-3 border-r border-b lg: border-border flex flex-col justify-between">
          <div className="flex items-center justify-between text-[10px] text-muted-foreground uppercase font-bold">
            ...
            <span className="text-foreground font-bold">ARPU.03</span>
          </div>
          <div className="my-2">
            <div className="text-lg md:text-xl font-bold tracking-tight text-foreground">$84.20</div>
          </div>
          <div className="flex items-center gap-1 tabular-nums text-[10px] text-muted-foreground">
            <span className="text-foreground font-bold">+$6.40</span>
        ...
        <div className="p-3 border-r border-b lg: border-border flex flex-col justify-between">
          <div className="flex items-center justify-between text-[10px] text-muted-foreground uppercase font-bold">
            ...
            <span className="text-foreground font-bold">LOSS.04</span>
          </div>
          <div className="my-2">
            <div className="text-lg md:text-xl font-bold tracking-tight text-foreground">2.4%</div>
          </div>
          <div className="flex items-center gap-1 tabular-nums text-[10px] text-muted-foreground">
            <span>IND. AVG: 6.8%</span>
            <span className="border border-border px-1 text-foreground font-bold">OPTIMAL</span>
          </div>
        </div>
        ...
        <div className="p-3 border-r border-border flex flex-col justify-between">
          <div className="flex items-center justify-between text-[10px] text-muted-foreground uppercase font-bold">
            ...
            <span className="text-foreground font-bold">RET.05</span>
          </div>
          <div className="my-2">
            <div className="text-lg md:text-xl font-bold tracking-tight text-foreground">74.2%</div>
          </div>
          <div className="flex items-center gap-1 tabular-nums text-[10px] text-muted-foreground">
            <span className="text-foreground font-bold">TARGET: &gt;70%</span>
            <span>[PASS]</span>
          </div>
        </div>
        ...
        <div className="p-3 flex flex-col justify-between">
          <div className="flex items-center justify-between text-[10px] text-muted-foreground uppercase font-bold">
            ...
            <span className="text-foreground font-bold">CHRN.06</span>
          </div>
          <div className="my-2">
            <div className="text-lg md:text-xl font-bold tracking-tight text-foreground">3.1%</div>
          </div>
          <div className="flex items-center gap-1 tabular-nums text-[10px] text-muted-foreground">
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 border-b border-border">
          ...
          <div className="lg:col-span-7 bg-card border-b lg: lg:border-r border-border flex flex-col">
            <div className="px-4 py-2 border-b border-border bg-muted/40 flex items-center justify-between">
              <div className="flex items-center gap-1">
                <span className="font-bold tabular-nums text-xs uppercase text-foreground">SEC:A // 30-DAY BOOKING WIZARD FUNNEL TELEMETRY</span>
              </div>
              <div className="flex items-center gap-2 tabular-nums text-[10px]">
                ...
                <span className="bg-primary text-primary-foreground px-1.5 font-bold">CONV_RATE: 22.4%</span>
              </div>
            </div>
            
            <div className="p-4 flex-1 flex flex-col justify-between gap-4">
              {/* ASCII / MONO CONVERSION BARS */}
              <div className="flex flex-col gap-3 tabular-nums text-xs">
                {/* STAGE 1 */}
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between items-baseline text-[10px] font-bold text-foreground">
                  ...
                  <div className="w-full h-6 border border-border bg-muted/40 flex items-center p-0.5">
                    <div className="h-full bg-black flex items-center px-2 text-white text-[9px] font-bold" style={{ width: '100%' }}>
                      ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ 100%
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="w-full h-6 border border-border bg-muted/40 flex items-center p-0.5">
                    <div className="h-full bg-black flex items-center px-2 text-white text-[9px] font-bold" style={{ width: '48.5%' }}>
                      ■■■■■■■■■■■■■■■ 48.5%
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="w-full h-6 border border-border bg-muted/40 flex items-center p-0.5">
                    <div className="h-full bg-black flex items-center px-2 text-white text-[9px] font-bold" style={{ width: '27.9%' }}>
                      ■■■■■■■■ 27.9%
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="w-full h-6 border border-border bg-muted/40 flex items-center p-0.5">
                    <div className="h-full bg-black flex items-center px-2 text-white text-[9px] font-bold" style={{ width: '23.6%' }}>
                      ■■■■■■ 23.6%
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between items-baseline text-[10px] font-bold text-foreground">
                    ...
                    <span className="font-bold">412 FULFILLED [22.4%]</span>
                  </div>
                  <div className="w-full h-6 border border-border bg-muted/40 flex items-center p-0.5">
                    <div className="h-full bg-black flex items-center px-2 text-white text-[9px] font-bold" style={{ width: '22.4%' }}>
                      ■■■■■ 22.4%
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 border-t border-border pt-4">
                <div className="border border-border p-3 bg-muted/30 flex flex-col justify-between">
                  <div className="flex justify-between text-[10px] font-bold uppercase">
                    ...
                    <span className="font-bold text-destructive">[ABANDON]</span>
                  </div>
                  <div className="my-2 flex items-baseline gap-2">
                    <span className="text-lg font-bold text-foreground">15.3%</span>
                ...
                <div className="border border-border p-3 bg-muted/30 flex flex-col justify-between">
                  <div className="flex justify-between text-[10px] font-bold uppercase">
                    ...
                    <span className="font-bold">[CLIENT DEVICE]</span>
                  </div>
                  <div className="my-2 flex items-baseline gap-2">
                    <span className="text-lg font-bold text-foreground">68% / 32%</span>
          ...
          <div className="lg:col-span-5 bg-card flex flex-col">
            <div className="px-4 py-2 border-b border-border bg-muted/40 flex items-center justify-between">
              <span className="font-bold tabular-nums text-xs uppercase text-foreground">SEC:D // RETENTION, LTV &amp; PRODUCT ATTACHMENT</span>
              <span className="tabular-nums text-[10px] text-muted-foreground">MDL:PRED-LTV</span>
            </div>
            
            <div className="p-4 flex-1 flex flex-col justify-between gap-4 tabular-nums text-xs">
              {/* RETENTION LEDGER ITEMS */}
              <div className="flex flex-col gap-3">
                <div className="border border-border p-3 bg-card">
                  <div className="flex justify-between items-center text-[10px] font-bold border-b border-border pb-1 mb-2">
                  ...
                  <div className="space-y-1 text-muted-foreground text-[11px]">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-foreground">42 ACCTS (48.8%)</span>
                    </div>
                    <div className="flex justify-between">
                      <span>↳ Reception Walk-in / Direct Phone:</span>
                      <span className="font-bold text-foreground">28 ACCTS (32.6%)</span>
                    </div>
                    <div className="flex justify-between">
                      <span>↳ Verified Peer/Client Referral:</span>
                      <span className="font-bold text-foreground">16 ACCTS (18.6%)</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-border p-3 bg-card">
                  ...
                  <div className="text-xl font-bold text-foreground mb-1">$342,000.00</div>
                ...
                <div className="border border-border p-3 bg-card">
                  <div className="flex justify-between items-center text-[10px] font-bold border-b border-border pb-1 mb-2">
                    ...
                    <span className="border border-border px-1 bg-muted/30 text-[9px] font-bold">34.2% ATTACH</span>
                  </div>
                  <div className="flex items-center gap-1.5 tabular-nums text-[11px] mb-2">
                    <span className="font-bold text-foreground">141 OF 412 GROOMS</span>
              ...
              <div className="p-2 border border-border bg-muted/40 flex items-center justify-between text-[10px] font-bold uppercase">
        ...
        <div className="w-full bg-card border-b border-border flex flex-col tabular-nums text-xs">
          <div className="px-4 py-2 border-b border-border bg-muted/40 flex flex-wrap items-center justify-between">
            <div className="flex items-center gap-1">
              <span className="font-bold text-xs uppercase text-foreground">SEC:B // MULTI-LOCATION FINANCIAL PERFORMANCE ROLLUP</span>
              <span className="bg-primary text-primary-foreground px-1.5 py-0.5 text-[9px] font-bold">3 OPERATING NODES</span>
            </div>
            ...
            <table className="w-full border-collapse text-left text-xs tabular-nums">
                ...
                <tr className="hover:bg-muted/30 transition-none">
                  <td className="p-3 border-r border-border font-bold">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="border border-border px-1 bg-muted/40 text-[9px] font-bold">LOC-01</span>
                    </div>
                  </td>
                  <td className="p-3 border-r border-border text-right">08 BAYS</td>
                  <td className="p-3 border-r border-border text-right font-bold">$34,820.00</td>
                  <td className="p-3 border-r border-border text-right">$31,450.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">91.2%</td>
                  ...
                  <td className="p-3 text-center">
                    <span className="border border-border bg-muted/30 text-[9px] font-bold px-1.5 py-0.5">OPERATIONAL</span>
                  </td>
                </tr>
                <tr className="hover:bg-muted/30 transition-none">
                  <td className="p-3 border-r border-border font-bold">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="border border-border px-1 bg-muted/40 text-[9px] font-bold">LOC-02</span>
                    </div>
                  </td>
                  <td className="p-3 border-r border-border text-right">05 BAYS</td>
                  <td className="p-3 border-r border-border text-right font-bold">$16,420.00</td>
                  <td className="p-3 border-r border-border text-right">$14,880.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">84.6%</td>
                ...
                <tr className="hover:bg-muted/30 transition-none">
                  <td className="p-3 border-r border-border font-bold">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="border border-border px-1 bg-muted/40 text-[9px] font-bold">MOB-TX</span>
                    </div>
                  </td>
                  <td className="p-3 border-r border-border text-right">03 VANS</td>
                  <td className="p-3 border-r border-border text-right font-bold">$7,250.00</td>
                  <td className="p-3 border-r border-border text-right">$6,520.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">96.0%</td>
                  <td className="p-3 border-r border-border text-right">05 STAFF</td>
                  <td className="p-3 border-r border-border text-right font-bold">$115.00</td>
                  <td className="p-3 text-center">
                    <span className="border border-border bg-muted/30 text-[9px] font-bold px-1.5 py-0.5">OPERATIONAL</span>
                  </td>
                </tr>
              ...
              <tfoot>
                <tr className="bg-muted/40 font-bold border-t-2 border-border text-foreground">
                  ...
                  <td className="p-3 border-r border-border text-right tabular-nums font-bold text-[13px]">$58,490.00</td>
                  <td className="p-3 border-r border-border text-right tabular-nums font-bold text-[13px]">$52,850.00</td>
                  ...
                  <td className="p-3 text-center">
                    <span className="bg-primary text-primary-foreground px-2 py-0.5 text-[9px] font-bold">[ALL HEALTHY]</span>
                  </td>
                </tr>
              </tfoot>
            </table>
        ...
        <div className="w-full bg-card flex flex-col tabular-nums text-xs">
          <div className="px-4 py-2 border-b border-border bg-muted/40 flex flex-wrap items-center justify-between">
            <div className="flex items-center gap-1">
              <span className="font-bold text-xs uppercase text-foreground">SEC:C // GROOMER COMMISSION, PERFORMANCE AUDIT &amp; TIPS SUMMARY</span>
            </div>
                ...
                <tr className="hover:bg-muted/30 transition-none">
                  <td className="p-3 border-r border-border">
                    <div className="flex flex-col">
                      <span className="font-bold text-foreground uppercase">Sarah Miller</span>
                      <span className="text-[10px] text-muted-foreground">Lead Groomer // Frisco HQ</span>
                    </div>
                  </td>
                  <td className="p-3 border-r border-border text-right font-bold">48 GROOMS</td>
                  ...
                  <td className="p-3 border-r border-border text-right font-bold">$1,944.00</td>
                  <td className="p-3 border-r border-border text-right">$780.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">4.98 ★</td>
                  <td className="p-3 text-right">
                    <span className="border border-border px-1.5 py-0.5 bg-muted/40 font-bold">82%</span>
                  </td>
                 </tr>
                <tr className="hover:bg-muted/30 transition-none">
                  <td className="p-3 border-r border-border">
                    <div className="flex flex-col">
                      <span className="font-bold text-foreground uppercase">Mike Ross</span>
                      <span className="text-[10px] text-muted-foreground">Canine Stylist {"//"} Frisco HQ</span>
                    </div>
                  </td>
                  <td className="p-3 border-r border-border text-right font-bold">42 GROOMS</td>
                  ...
                  <td className="p-3 border-r border-border text-right font-bold">$1,533.00</td>
                  <td className="p-3 border-r border-border text-right">$610.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">4.91 ★</td>
                  <td className="p-3 text-right">
                    <span className="border border-border px-1.5 py-0.5 bg-muted/40 font-bold">76%</span>
                  </td>
                </tr>
                <tr className="hover:bg-muted/30 transition-none">
                  <td className="p-3 border-r border-border">
                    <div className="flex flex-col">
                      <span className="font-bold text-foreground uppercase">Jessica Lee</span>
                      <span className="text-[10px] text-muted-foreground">Senior Stylist {"//"} Plano West</span>
                    </div>
                  </td>
                  <td className="p-3 border-r border-border text-right font-bold">38 GROOMS</td>
                  <td className="p-3 border-r border-border text-right">$3,190.00</td>
                  <td className="p-3 border-r border-border text-right">42% BASE</td>
                  <td className="p-3 border-r border-border text-right font-bold">$1,339.80</td>
                  <td className="p-3 border-r border-border text-right">$540.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">4.95 ★</td>
                  <td className="p-3 text-right">
                    <span className="border border-border px-1.5 py-0.5 bg-muted/40 font-bold">79%</span>
                  </td>
                </tr>
                <tr className="hover:bg-muted/30 transition-none">
                  <td className="p-3 border-r border-border">
                    <div className="flex flex-col">
                      <span className="font-bold text-foreground uppercase">Kevin Diaz</span>
                      <span className="text-[10px] text-muted-foreground">Mobile Tech {"//"} Van-02</span>
                    </div>
                  </td>
                  <td className="p-3 border-r border-border text-right font-bold">31 GROOMS</td>
                  ...
                  <td className="p-3 border-r border-border text-right font-bold">$1,782.50</td>
                  <td className="p-3 border-r border-border text-right">$690.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">4.99 ★</td>
                  <td className="p-3 text-right">
                    <span className="border border-border px-1.5 py-0.5 bg-muted/40 font-bold">88%</span>
                  </td>
                </tr>
              </tbody>
              <tfoot>
                <tr className="bg-muted/40 text-foreground text-[10px] uppercase font-bold">
                  ...
                  <td className="p-3 border-r border-border text-right font-bold">$6,599.30</td>
                  <td className="p-3 border-r border-border text-right font-bold">$2,620.00</td>
                  <td className="p-3 border-r border-border text-right font-bold">4.96 ★ AVG</td>
                  <td className="p-3 text-right font-bold">81.2% AVG</td>
                </tr>
              </tfoot>
            </table>
          </div>
      ...
      <div className="w-full bg-muted/30 border-b border-border p-4 flex flex-col md:flex-row items-center justify-between gap-4 select-none tabular-nums text-xs">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2 text-[10px] font-bold text-foreground uppercase">
              ...
              <span className="border border-border px-1.5 bg-card text-[9px] font-bold">[HARDWARE KEY VERIFIED]</span>
            </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="border border-border bg-card px-2 py-0.5 text-foreground font-bold tabular-nums">LOG_ID #TX-90412-2025</span>
          <button 
