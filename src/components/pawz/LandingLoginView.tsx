      ...
      <main className="w-full grid grid-cols-1 lg:grid-cols-2 bg-black">
        ...
        >
          <div className="w-full max-w-[360px] flex flex-col my-auto py-8">
            ...
            {/* Staff Sign In — redirects to /login (Google OAuth for staff only) */}
            <a
              href="/login"
              className="w-full py-2.5 px-4 bg-primary hover:bg-primary/90 border border-primary rounded-md text-primary-foreground text-[13px] font-semibold flex items-center justify-center gap-3 transition shadow-xs cursor-pointer mb-3"
            >
              <ShieldCheck className="w-4 h-4 shrink-0" />
              <span>Staff &amp; Admin Sign In</span>
            </a>
            <p className="text-center text-[11px] text-muted-foreground/80 mb-5 leading-relaxed">
              Staff access is via Google (authorized salon personnel only).<br />
              <span className="font-medium">Customers don&apos;t register here</span> — you&apos;ll create an account at checkout or booking.
            </p>
